package id.ac.polbeng.riskiafendi.kabupatenkotariauapp
...
import id.ac.polbeng.riskiafendi.kabupatenkotariauapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setSupportActionBar(findViewById(R.id.my_toolbar)) //tambahan
